...
// 5. Write a program to create user defined exceptions called HrsException. MinException and SecException. Create a class Time which contains data members hours. minutes. seconds and throw the user defined exceptions if hours (>24 & <0).minutes(>60 & <0).seconds(>60 & <0).
